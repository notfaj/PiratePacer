...
quest_pattern = '''?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ??
                ...
                ?? ?? ?? ?? ?? ?? ?? ?? ?? 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ??
                ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? e7 1d 41 00 ?? ?? ?? ?? ?? ?? ?? ?? ??
                ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 78 40 a3 01 ff ff ff ff
                7c fe 4d 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 00 00 00
                00 00 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? d0 74 a4 01 00 00 00 00 ?? ??
                ?? ?? ?? ?? ?? ?? ?? ?? ?? 77 ?? ?? ?? ?? ?? ?? 00 00 00 00 00 00 01 
                00 00 00 45 e0 4d 00 ?? ?? 00 00 92 c1 4d 00 ?? ?? ?? ?? e1 27 4d 00
                ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ??
                ?? ?? ?? ?? ?? 00 00 00 00 20 2f ?? ?? 00 00 00 00'''
...
class Player(Memory):
    ...
    def find_base(self) -> int:
        self.topAddress = self.get_add("Pirate.exe", self.convert_pattern_to_bytes(real_z_pattern))
        return self.topAddress
